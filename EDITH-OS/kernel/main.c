...
//  char bufr[rd_bytes];
    ...
    while (1) {
        printf("[@edith: %s]", current_dirr);  // 打印当前路径
...
void help()
{
    printf("    ===========================   G E T  H E L P  ===========================\n");
    printf("   |   process             : A process manage,show you all process-info here |\n");
    printf("   |   filemng             : Run the file manager                            |\n");
    printf("   |   clear               : Clear the screen                                |\n");
    printf("   |   help                : Operation instructions                          |\n");
    printf("   |   ls                  : Display information in the current directory.   |\n");
    printf("   |   touch     filename  : Create a new file                               |\n");
    printf("   |   rm        filename  : Delete a file                                   |\n");
    printf("   |   cat       filename  : Choose a file to read information.              |\n");
    printf("   |   vi        filename  : Choose a file to write information.             |\n");
    printf("   |   mkdir     dirname   : Create a new directory                          |\n");
    printf("   |   cd        dirname   : Go to a directory in current directory          |\n");
    printf("   |   chess               : Run a small game 'Fivechess' on this OS         |\n");
    printf("   |   mine                : Run a small game 'Minesweeper'on this OS        |\n");   
    printf("    =========================================================================\n");
}
